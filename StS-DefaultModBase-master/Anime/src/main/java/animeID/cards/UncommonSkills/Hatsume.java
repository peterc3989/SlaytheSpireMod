...
public class Hatsume extends AbstractDynamicCard {

    public static final String ID = MyHeroMod.makeID(Hatsume.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;

    public static final String IMG = makeCardPath("Hatsume.png");//
