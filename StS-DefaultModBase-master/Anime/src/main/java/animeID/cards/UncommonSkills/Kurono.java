...
public class Kurono extends AbstractDynamicCard {

    public static final String ID = MyHeroMod.makeID(Kurono.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;

    public static final String IMG = makeCardPath("Kurono.png");//
