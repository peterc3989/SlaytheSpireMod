...
public class NightEye extends AbstractDynamicCard {

    public static final String ID = MyHeroMod.makeID(NightEye.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;

    public static final String IMG = makeCardPath("NightEye.png");//
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
                ...
                m.intent==AbstractMonster.Intent.ATTACK_DEFEND)
        {
            this.addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new StrengthPower(AbstractDungeon.player, 1), 1));
                ...
                m.intent==AbstractMonster.Intent.DEFEND_BUFF|
                m.intent==AbstractMonster.Intent.DEFEND_DEBUFF)
        {
