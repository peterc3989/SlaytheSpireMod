...
public class FatGum extends AbstractDynamicCard {

    public static final String ID = MyHeroMod.makeID(FatGum.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;

    public static final String IMG = makeCardPath("FatGum.png");//
