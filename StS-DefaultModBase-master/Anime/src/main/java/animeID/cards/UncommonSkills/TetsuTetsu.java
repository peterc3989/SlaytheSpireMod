...
public class TetsuTetsu extends AbstractDynamicCard {

    public static final String ID = MyHeroMod.makeID(TetsuTetsu.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;

    public static final String IMG = makeCardPath("TetsuTetsu.png");//
