...
public class MtLady extends AbstractDynamicCard {

    public static final String ID = MyHeroMod.makeID(MtLady.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;

    public static final String IMG = makeCardPath("MtLady.png");//
