...
public class Uraraka extends AbstractDynamicCard {

    public static final String ID = MyHeroMod.makeID(Uraraka.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;

    public static final String IMG = makeCardPath("Uraraka.png");//
