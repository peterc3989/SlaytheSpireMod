...
public class Smash extends AbstractDynamicCard {
    ...
    public static final String ID = MyHeroMod.makeID(Smash.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;

    public static final String IMG = makeCardPath("Smash.png");//
