...
public class Rei extends AbstractDynamicCard {

    public static final String ID = MyHeroMod.makeID(Rei.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;

    public static final String IMG = makeCardPath("Rei.png");//
