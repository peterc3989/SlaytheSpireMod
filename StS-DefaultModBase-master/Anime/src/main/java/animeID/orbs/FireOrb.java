package animeID.orbs;

import animeID.actions.FireOrbEvokeAction;
...
public class FireOrb extends AbstractOrb {
    ...
    public static final String ORB_ID = MyHeroMod.makeID("FireOrb");
    ...
    public void updateDescription() { // Set the on-hover description of the orb
        ...
        description = DESC[0] + passiveAmount + DESC[1] + passiveAmount/2 + DESC[2] + DESC[3]+ evokeAmount + DESC[4]+ evokeAmount/2 + DESC[5]; // Set the description
    }
    ...
    public void onEvoke() { // 1.On Orb Evoke
        ...
        AbstractDungeon.actionManager.addToTop(new FireOrbEvokeAction(new DamageInfo(AbstractDungeon.player, this.evokeAmount, DamageInfo.DamageType.THORNS), false,this.evokeAmount/2));
    ...
    public void onEndOfTurn() {
        ...
        AbstractDungeon.actionManager.addToTop(new FireOrbEvokeAction(new DamageInfo(AbstractDungeon.player, this.passiveAmount, DamageInfo.DamageType.THORNS), false,this.passiveAmount/2));
